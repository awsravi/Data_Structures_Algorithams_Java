...
public class CircularSingleLinkedList {
    ...
    // Insert Circular Single linked list
    ...
    // Search Method Circular Linked List
    public boolean searchCircularLinkedList(int location) {
        if (head != null) {
            Node tempNode = head;
            for (int i = 0; i < size; i++) {
                if (tempNode.value == location) {
    ...
    public void deleteCircularLinkedList(int location) {
        if (head == null) {
